<template>
	<view class="classCourseDetail" :style="{ background: backColor }">
		...
		<u-sticky index="header3" customNavHeight="45" zIndex="10001" :disabled="true">
			<view class="main-body bd" :style="{'minHeight':  300 +'px'}">
				<u-sticky customNavHeight="45" index="header3" zIndex="1000">
					<slot name="slot1">123</slot>
				</u-sticky>
				<view class="list">
					<view>1</view>
					<view>2</view>
...
<style lang="scss" scoped>
	.classCourseDetail {
		...
		.main-body {
			...
			z-index: 2000;
			top: px2Rpx(-1);
			/* ios需加，否则main-body不会在header-bottom上 */
		}
