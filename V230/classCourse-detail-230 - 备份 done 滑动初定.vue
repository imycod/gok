<template>
	<view class="classCourseDetail" :style="{ background: backColor }">
		...
		<view class="main-body" @touchmove="pageScroll" :style="{'minHeight':  300 +'px'}">
			<u-sticky ref="tabs" customNavHeight="45" index="header3" zIndex="1000" :disabled="false">
				<!-- 章节、活动tab -->
			...
			<view class="list-body" @touchstart="touchStart" @touchend="touchEnd"
				...
				<view v-if="who==1 || who==2">
					<chaptersTeacherList :from="from" ref="chapters" :who="who" :chapterList="chapterList"
						:classId="classId" :courseId="courseId" :activeFlag="activeFlag" v-if="curTab === 'chapter'">
					</chaptersTeacherList>
				</view>
				<view v-if="who==0">
				...
				<activitiesList :from="from" :who="who" :activityList="activityList" :currentActState="currentActState"
					:classId="classId" :courseId="courseId" v-if="curTab === 'activity'"></activitiesList>
			</view>
...
<style lang="scss" scoped>
	.classCourseDetail {
		...
		.main-body {
			position: sticky;
			width: px2Rpx(750);
			border-radius: px2Rpx(30) px2Rpx(30) 0 0;
			position: relative;
			z-index: 2000;
			top: px2Rpx(240);
