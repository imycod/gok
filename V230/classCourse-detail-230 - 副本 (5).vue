	...
	<view class="classCourseDetail" :style="{ background: backColor }">
		...
		<u-sticky index="header1" zIndex="10001" :disabled="false">
			...
			<nav-bar :border="false" :fixed="false" :statusBar="true" :backgroundColor="getBgColor(classId)"
				:back="true" color="#ffffff" v-if="true">
		...
		<u-sticky offset-top="45" index="header2" zIndex="10001" :disabled="true">
			<view class="main-body" :style="{'minHeight':  300 +'px'}">
				<u-sticky customNavHeight="45" index="header3"  zIndex="1000" :disabled="false" >
					<!-- 章节、活动tab -->
