var OneTrustStub = function(e) {
    "use strict";
    var t, o, i, n, a, r, s, l, c, p, u, d, m, h, g, f, b, A, v, y, C, S, I, L, D, w, T, B, R, E, _, P, U, k, O, G, F, V, N, x, M, H, j, z, K, J, q, W, Y, Q, X, Z, $, ee, te, oe, ie, ne, ae, re, se, le, ce, pe = new function() {
    ...
    function fe(e, t, o) {
        ...
        n = o && a ? function() {
            for (var e = a.split(";").concat(r.split(";")).filter(function(e) {
                    return 0 !== e.length
                }), t = "", o = "", i = e.length - 1; 0 <= i; i--) {
                var n = e[i].substring(0, e[i].indexOf(":")).trim();
                t.indexOf(n) < 0 && (t += n, o += e[i] + ";")
            }
            return o
        }() : r, e.setAttribute("style", n)
    }
    var be = (Ae.prototype.initConsentSDK = function() {
    ...
    }, Ae.prototype.captureNonce = function() {
        this.nonce = pe.stubScriptElement.nonce || pe.stubScriptElement.getAttribute("nonce") || null
    }, Ae.prototype.fetchBannerSDKDependency = function() {
        this.setDomainDataFileURL(), this.crossOrigin = pe.stubScriptElement.getAttribute("crossorigin") || null, this.previewMode = "true" === pe.stubScriptElement.getAttribute("data-preview-mode"), this.otFetch(pe.bannerDataParentURL, this.getLocation.bind(this))
    }, Ae.prototype.setDomainIfBulkDomainEnabled = function(e) {
        var t = e && e.TenantFeatures,
            o = window.location.hostname,
            i = e.Domain,
            n = e.BulkDomainCheckUrl;
        if (t && t.CookieV2BulkDomainManagement && o !== i && e.ScriptType === me) {
            var a = window.sessionStorage;
            if (a && a.getItem("bulkDomainMgmtEnabled")) this.handleBulkDomainMgmt({
                isValid: "true" === window.sessionStorage.getItem("bulkDomainMgmtEnabled")
            }, e);
            else {
                var r = {
                    location: pe.storageBaseURL.replace(/^https?:\/\//, ""),
                    domainId: this.domainId,
                    url: o
                };
                this.otFetch(n, this.handleBulkDomainMgmt, !1, r, e)
            }
        }
    }, Ae.prototype.getLocation = function(e) {
        ...
        if (t.OneTrust && t.OneTrust.geolocationResponse) {
            ...
            var i = this.readCookieParam(pe.optanonCookieName, pe.geolocationCookiesParam);
            if (i || e.SkipGeolocation) {
                var n = i.split(";")[0],
                    a = i.split(";")[1];
                this.setGeoLocation(n, a), this.addBannerSDKScript(e)
            } else this.getGeoLocation(e)
        }
    }, Ae.prototype.handleBulkDomainMgmt = function(e, t) {
    ...
    }, Ae.prototype.getGeolocationURL = function(e) {
        e.TenantFeatures;
        var t = "" + pe.stubScriptElement.getAttribute("src").split(pe.stubFileName)[0] + e.Version;
        if (new RegExp("^file://", "i").test(t) && e.MobileSDK) {
            var o = "/" + e.GeolocationUrl.replace(/^(http|https):\/\//, "").split("/").slice(1).join("/") + ".js";
            return pe.storageBaseURL + o
        }
        return e.GeolocationUrl
    }, Ae.prototype.geoLocationJsonCallback = function(e, t) {
        t && this.setGeoLocation(t.country, t.state), this.addBannerSDKScript(e)
    }, Ae.prototype.getGeoLocation = function(e) {
        var t = this.getGeolocationURL(e);
        this.otFetch(t, this.geoLocationJsonCallback.bind(this, e), !0)
    }, Ae.prototype.setOTDataLayer = function() {
        var e = "data-dLayer-ignore",
            t = pe.stubScriptElement.hasAttribute(e),
            o = pe.stubScriptElement.getAttribute(e),
            i = t && "true" === o || t && "" === o;
        this.otDataLayer = {
            ignore: i,
            name: pe.stubScriptElement.getAttribute("data-dLayer-name") || "dataLayer"
        }
    }, Ae.prototype.setGeoLocation = function(e, t) {
        void 0 === t && (t = ""), pe.userLocation = {
            country: e,
            state: t
        }
    }, Ae.prototype.otFetch = function(e, o, t, i, n) {
        void 0 === t && (t = !1), void 0 === i && (i = null);
        var a = window.sessionStorage && window.sessionStorage.getItem("otPreviewData");
        if (new RegExp("^file://", "i").test(e)) this.otFetchOfflineFile(e, o);
        else if (0 <= e.indexOf("/consent/") && this.previewMode && a) {
            var r = JSON.parse(a).domainJson;
            o(r)
        } else {
            pe.mobileOnlineURL.push(e);
            var s = new XMLHttpRequest;
            if (s.onload = function(e) {
                    var t;
                    this && this.responseText ? t = this.responseText : e && e.target && (t = e.target.responseText), n ? o(JSON.parse(t), n) : o(JSON.parse(t))
                }, s.onerror = function() {
                    o()
    ...
    }, Ae.prototype.otFetchOfflineFile = function(e, t) {
        var o = (e = e.replace(".json", ".js")).split("/"),
            i = o[o.length - 1].split(".js")[0];
        this.jsonp(e, function() {
            t(window[i])
        })
    }, Ae.prototype.jsonp = function(e, t) {
        var o = document.createElement("script");
        o.setAttribute("src", e), this.nonce && o.setAttribute("nonce", this.nonce), o.async = !0, o.type = "text/javascript", this.crossOrigin && o.setAttribute("crossorigin", this.crossOrigin), document.getElementsByTagName("head")[0].appendChild(o), new RegExp("^file://", "i").test(e) || pe.mobileOnlineURL.push(e), t && (o.onload = o.onerror = function() {
            t()
        })
    }, Ae.prototype.getRegionSet = function(e) {
        var t, o, i, n = pe.userLocation,
            a = e.RuleSet.filter(function(e) {
                return !0 === e.Default
            });
        if (!n.country && !n.state) return a && 0 < a.length ? a[0] : null;
        for (var r = n.state.toLowerCase(), s = n.country.toLowerCase(), l = 0; l < e.RuleSet.length; l++)
        ...
        return o || t || i
    }, Ae.prototype.ensureHtmlGroupDataInitialised = function() {
        this.initializeIABData(), this.initializeGroupData(), this.initializeHostData(), this.initializeGenVenData()
    }, Ae.prototype.initializeGroupData = function() {
        var e = this.readCookieParam(pe.optanonCookieName, "groups");
        e && (pe.optanonHtmlGroupData = this.deserialiseStringToArray(e))
    }, Ae.prototype.initializeHostData = function() {
        var e = this.readCookieParam(pe.optanonCookieName, "hosts");
        e && (pe.optanonHostData = this.deserialiseStringToArray(e))
    }, Ae.prototype.initializeGenVenData = function() {
        var e = this.readCookieParam(pe.optanonCookieName, "genVendors");
        e && (pe.genVendorsData = this.deserialiseStringToArray(e))
    }, Ae.prototype.initializeIABData = function() {
        this.validateIABGDPRApplied(), this.validateIABGlobalScope()
    }, Ae.prototype.validateIABGlobalScope = function() {
        var e = this.readCookieParam(pe.optanonCookieName, pe.oneTrustIsIABCrossConsentEnableParam);
        e ? "true" === e ? (pe.hasIABGlobalScope = !0, pe.isStubReady = !1) : (pe.hasIABGlobalScope = !1, pe.IABCookieValue = this.getCookie(pe.oneTrustIABCookieName)) : pe.isStubReady = !1
    }, Ae.prototype.validateIABGDPRApplied = function() {
        var e = this.readCookieParam(pe.optanonCookieName, pe.geolocationCookiesParam).split(";")[0];
        e ? this.isBoolean(e) ? pe.oneTrustIABgdprAppliesGlobally = "true" === e : pe.oneTrustIABgdprAppliesGlobally = 0 <= pe.EUCOUNTRIES.indexOf(e) : pe.isStubReady = !1
    }, Ae.prototype.isBoolean = function(e) {
        return "true" === e || "false" === e
    }, Ae.prototype.readCookieParam = function(e, t) {
        var o, i, n, a, r = this.getCookie(e);
        if (r) {
            for (i = {}, n = r.split("&"), o = 0; o < n.length; o += 1) a = n[o].split("="), i[decodeURIComponent(a[0])] = decodeURIComponent(a[1]).replace(/\+/g, " ");
            return t && i[t] ? i[t] : t && !i[t] ? "" : i
        }
        return ""
    }, Ae.prototype.getCookie = function(e) {
        if (this.isAmp) {
        ...
        return null
    }, Ae.prototype.updateGtmMacros = function() {
        var e, t = [],
            o = pe.optanonHtmlGroupData.length;
        for (e = 0; e < o; e++) this.endsWith(pe.optanonHtmlGroupData[e], ":1") && t.push(pe.optanonHtmlGroupData[e].replace(":1", ""));
        for (o = pe.optanonHostData.length, e = 0; e < o; e++) this.endsWith(pe.optanonHostData[e], ":1") && t.push(pe.optanonHostData[e].replace(":1", ""));
        for (o = pe.genVendorsData.length, e = 0; e < o; e++) this.endsWith(pe.genVendorsData[e], ":1") && t.push(pe.genVendorsData[e].replace(":1", ""));
        for (o = pe.vendorsServiceData.length, e = 0; e < o; e++) this.endsWith(pe.vendorsServiceData[e], ":1") && t.push(pe.vendorsServiceData[e].replace(":1", ""));
        ...
        !this.otDataLayer.ignore && t.length && (n[this.otDataLayer.name].constructor === Array && n[this.otDataLayer.name].push({
            ...
            t.length && window.dispatchEvent(r), a && window.dispatchEvent(a)
        })
    }, Ae.prototype.deserialiseStringToArray = function(e) {
        return e ? e.split(",") : []
    }, Ae.prototype.endsWith = function(e, t) {
        return -1 !== e.indexOf(t, e.length - t.length)
    }, Ae.prototype.serialiseArrayToString = function(e) {
        return e.toString()
    }, Ae.prototype.setStubScriptElement = function() {
        pe.stubScriptElement = document.querySelector("script[src*='" + pe.stubFileName + "']");
        var e = pe.stubScriptElement && 0 <= pe.stubScriptElement.getAttribute("src").indexOf("did=");
        pe.stubScriptElement && pe.stubScriptElement.hasAttribute(pe.DATAFILEATTRIBUTE) ? this.domainId = pe.stubScriptElement.getAttribute(pe.DATAFILEATTRIBUTE).trim() : e ? this.domainId = pe.stubScriptElement.getAttribute("src").split("did=")[1] : pe.stubScriptElement || (pe.stubScriptElement = document.querySelector("script[src*='" + pe.migratedCCTID + "']"), pe.stubScriptElement && (pe.isMigratedURL = !0, this.domainId = pe.migratedDomainId.trim()))
    }, Ae.prototype.setDomainDataFileURL = function() {
        var e = pe.stubScriptElement.getAttribute("src"),
            t = -1 < e.indexOf("/consent");
        e && (pe.isMigratedURL ? pe.storageBaseURL = e.split("/consent/" + pe.migratedCCTID)[0] : pe.storageBaseURL = t ? e.split("/consent")[0] : e.split("/scripttemplates/" + pe.stubFileName)[0]), this.storageBaseURL = pe.storageBaseURL, this.isPreview && -1 === this.domainId.indexOf("test") ? this.domainId = this.domainId + "-test" : this.isPreview = !1, pe.bannerBaseDataURL = pe.storageBaseURL && pe.storageBaseURL + "/consent/" + this.domainId, pe.bannerDataParentURL = pe.bannerBaseDataURL + "/" + this.domainId + ".json"
    }, Ae.prototype.initCustomEventPolyfill = function() {
    ...
    }, Ae.prototype.getParam = function() {
        ...
        var o = this.readCookieParam(de, "expiry"),
            i = this.readCookieParam(de, ue);
        this.isReset = e || o && new Date(o) < new Date, this.isPreview = !this.isReset && (t || o && new Date(o) > new Date), this.setGeoParam(this.geoFromUrl || i)
    }, Ae.prototype.setGeoParam = function(e) {
        if (e) {
            var t = window;
    ...
    function Ae() {
        ...
        this.iabType = null, this.iabTypeAdded = !0, this.crossOrigin = null, this.isAmp = !1, this.domainId = "", this.isReset = !1, this.isPreview = !1, this.geoFromUrl = "", this.nonce = "", this.setAttributePolyfillIsActive = !1, this.storageBaseURL = "", this.charset = null, this.addBannerSDKScript = function(e) {
            ...
            t.GCEnable || (c.updateGtmMacros(), c.gtmUpdated = !0), c.iabTypeAdded && ("IAB" !== t.Type && "IAB2" !== t.Type || (c.iabType = t.Type, c.intializeIabStub()), "IAB2" !== t.Type && c.removeTcf());
            var o = pe.stubScriptElement.cloneNode(!0),
                i = "";
            i = e.UseSDKRefactor ? (pe.isMigratedURL && (o.src = pe.storageBaseURL + "/scripttemplates/new/scripttemplates/" + pe.stubFileName + ".js"), pe.storageBaseURL + "/scripttemplates/new/scripttemplates/" + e.Version + "/" + pe.bannerScriptName) : "5.11.0" === e.Version ? (pe.isMigratedURL && (o.src = pe.storageBaseURL + "/scripttemplates/old/scripttemplates/" + pe.stubFileName + ".js"), pe.storageBaseURL + "/scripttemplates/old/scripttemplates/5.11.0/" + pe.bannerScriptName) : (pe.isMigratedURL && (o.src = pe.storageBaseURL + "/scripttemplates/" + pe.stubFileName + ".js"), pe.storageBaseURL + "/scripttemplates/" + e.Version + "/" + pe.bannerScriptName);
            ["charset", "data-language", "data-document-language", "data-domain-script", "crossorigin", "data-ignore-ga"].forEach(function(e) {
                pe.stubScriptElement.getAttribute(e) && o.setAttribute(e, pe.stubScriptElement.getAttribute(e))
            }), c.charset = pe.stubScriptElement.getAttribute("charset"), c.isAmp = !!pe.stubScriptElement.getAttribute("amp"), window.otStubData = {
                bannerBaseDataURL: pe.bannerBaseDataURL,
                ...
                isReset: c.isReset,
                mobileOnlineURL: pe.mobileOnlineURL,
                nonce: c.nonce,
            ...
            fe(i, "display: none;", !0), i.name = e, i.setAttribute("title", t + " Locator"), o.document.body.appendChild(i)
            ...
            if (e.__tcfapiCall && "IAB2" === c.iabType) {
                ...
                c.executeTcfApi(l, t, function(e, t) {
                    ...
                    i && i.source && i.source.postMessage && i.source.postMessage(n ? JSON.stringify(o) : o, "*")
                }, o)
            ...
            if ("function" == typeof n && o)
                if (pe.isStubReady && pe.IABCookieValue) switch (o) {
                    case "ping":
            ...
            var o = e[0],
                ...
                n = e[2],
                a = e[3];
            "function" == typeof n && o && ("ping" === o ? c.getPingRequest(n) : c.addToQueue(o, i, n, a))
            ...
            if (void 0 === t && (t = !1), e) {
                var o = {},
                    i = !1;
                "IAB" === c.iabType ? (o = {
                    gdprAppliesGlobally: pe.oneTrustIABgdprAppliesGlobally,
                    cmpLoaded: t
                }, i = !0) : "IAB2" === c.iabType && (o = {
                    gdprApplies: pe.oneTrustIABgdprAppliesGlobally,
                    cmpLoaded: !1,
                    cmpStatus: "stub",
                    displayStatus: "stub",
                    apiVersion: "2.0",
            ...
            e && pe.IABCookieValue && e({
                gdprApplies: pe.oneTrustIABgdprAppliesGlobally,
                hasGlobalScope: pe.hasIABGlobalScope,
                consentData: pe.IABCookieValue
            }, !0)
        }, this.initConsentSDK()
    }
    var ve = new be;
    return e.OtSDKStub = be, e.otSdkStub = ve, e
}({});